...
public class VectorD {
	...
	/**
	 * Calculate the cross product of this vector and the given vector. NOTE: this only uses the
	 * first two values of each vector
	 * 
	 * @param vec the other vector
	 * 
	...
	/**
	 * Subtract the given vector to this vector and return a new vector with the result
	 * 
