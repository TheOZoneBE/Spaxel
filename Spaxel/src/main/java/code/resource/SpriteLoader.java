...
public class SpriteLoader extends EntityLoader{
	...
	public Map<String, SpriteData> loadSprites(String sheets, String sprites){
		...
		for(int i = 0; i < nodelist.getLength(); i++){
			...
			spriteAtlas.put(spriteName, new SpriteData(spriteWidth, spriteHeight,spriteXPos*spriteWidth, spriteYPos*spriteHeight, spritesheetAtlas.get(spritesheetName)));
